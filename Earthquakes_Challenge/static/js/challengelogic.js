...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  let tectonicURL = "https://raw.githubusercontent.com/fraxen/tectonicplates/339b0c56563c118307b1f4542703047f5f698fae/GeoJSON/PB2002_plates.json";
  let lineStyle = {
    color: "#221fe4",
    weight: 2
  }
  ...
  d3.json(tectonicURL).then(function(data) {
    L.geoJSON(data, {
      style: lineStyle,
      onEachFeature: function(feature, layer){
        layer.bindPopup(`Plate Name: ${feature.properties.PlateName}<br/>Code: ${feature.properties.Code}`)
      }
